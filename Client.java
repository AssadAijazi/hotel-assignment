...
public class Client {
	...
	public Client(int id, String ln, String fn, Dates dateIn, Dates dateOut,
			Room rm) {
		setCustomerID(id);
		setLastName(ln);
		setFirstName(fn);
	...
	public void setBedroom(Room rm) {
		bedroom = rm;
	}
	...
	public String toString() {
		...
		return customerID + " " + lastName + " " + firstName + " "
				+ arrive.toString() + " " + leave.toString() + " "
				+ bedroom.toString();
	}

	public String output() {
		return "Customer ID: " + customerID + "; Last Name: " + lastName
				+ "; First Name: " + "Arrival Date: " + arrive.output()
				+ "; Departure Date: " + leave.output() + "; Bedroom: "
				+ bedroom.toString();
	}
